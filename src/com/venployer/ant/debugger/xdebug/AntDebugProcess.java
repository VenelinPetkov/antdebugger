...
import com.venployer.ant.debugger.breakpoint.AntDebugListener;
import com.venployer.ant.debugger.breakpoint.AntDebuggerProxy;
import com.venployer.ant.debugger.breakpoint.BreakpointPosition;
import com.venployer.ant.debugger.util.ConsoleUtil;
...
public class AntDebugProcess extends XDebugProcess {
    ...
    private class MyAntDebugListener implements AntDebugListener {
        ...
        public void onBreakpoint(BreakpointPosition pos) {
            ...
            if (xBreakpoint != null) {
                if (debugSession.breakpointReached(xBreakpoint, null, suspendContext)) {
                } else {
                    resume();
                }
            } else {
