...
public class AntRunSettingsEditor extends SettingsEditor<AntRunConfiguration> {
    ...
    public AntRunSettingsEditor(java.util.List<String> jdkNames, Project project) {
        ...
        sdks.add(0, "[None]");
        myJdkName = new JComboBox(com.venployer.ant.debugger.util.StringUtil.toArray(sdks));
    ...
    private void loadTargets() {
        ...
        myTargetName.setModel(new DefaultComboBoxModel(com.venployer.ant.debugger.util.StringUtil.toArray(targets)));
    }
